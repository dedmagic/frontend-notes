...
* `global`, `ignoreCase`, `multiline`, `dotAll`, `sticky`, `unicode` – булевские свойства, содержащие `true` или `false` в зависимости от того, включён соответствующий режим или нет (т.е. присутствует или отсутствует флаг); только для чтения
